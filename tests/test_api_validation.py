...
class TestAPIKeyValidation:
    ...
    def test_valid_api_key(self, monkeypatch):
        ...
        from api_server import require_training_key
...
class TestLSTMStatusTracking:
    ...
    def test_lstm_unavailable_flag_on_missing_model(self, mocker, monkeypatch):
        ...
        mocker.patch(
            "api_server.resolve_shared_path",
            return_value="/nonexistent/path/model.h5"
        )
...
class TestDataUploadValidation:
    ...
    def test_oversized_upload_rejected(self):
        ...
        from api_server import validate_upload, MAX_UPLOAD_BYTES
